import { type IGraph, makeGraphApi } from '~/Graphs/Graph.js';
import type { Dependencies } from '~/types/registry.js';
import type { NodeConfiguration } from '../src/Nodes/Node.js';
import type {
  IFunctionNodeDefinition,
  IHasTriggered,
  SocketNames,
  SocketsDefinition
} from '../src/Nodes/NodeDefinitions.js';
import { makeOrGenerateSockets } from '../src/Nodes/nodeFactory.js';
import type { NodeConfigurationDescription } from '../src/Nodes/Registry/NodeDescription.js';
...
export type RecordedWritesOrCommits<TOutput extends SocketsDefinition> = (
  | {
      outputType: typeof RecordedOutputType.write;
      socketName: SocketNames<TOutput>;
      value: any;
    }
  | {
      outputType: typeof RecordedOutputType.commit;
      socketName: SocketNames<TOutput>;
    }
)[];
...
>(
  ...
  let state: TState = structuredClone(initialState);
