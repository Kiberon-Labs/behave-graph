...
import { useSystem, BasePanel, Icon } from '@kiberon-labs/behave-graph-flow';
...
/**
 * The chat panel bound to `system.chatStore`. Sending publishes
 * `chat:userMessage`, which the {@link ConversationRuntime} handles to drive the
 * focused conversation and stream a reply back into the store. Both the store
 * and the topic are contributed by this (AI) package , see `ui.tsx`.
 */
