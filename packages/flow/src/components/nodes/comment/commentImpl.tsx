...
/**
 * The actual comment node, pulling in tiptap/prosemirror (~320 KB). It is loaded
 * lazily by `comment.tsx` so that weight only lands in the bundle when a comment
 * node is actually rendered.
 */
export const CommentNodeImpl = ({
  data,
  selected,
  id
