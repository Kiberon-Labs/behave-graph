---
"@kiberon-labs/behave-graph-nodes-ai": minor
"@kiberon-labs/behave-graph-flow": minor
"@kiberon-labs/behave-graph-nodes-image": minor
---

New AI nodes package (agents, conversations, tools, multimodal), plus the
...
- **Realtime preview runner**: evaluate every *watched* node output (pull the
